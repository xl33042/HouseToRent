  ...
  <div class="app-container">
    <el-form :inline="true" :model="listQuery">
      <el-form-item label="单位名称">
        <el-select v-model="listQuery.agentId" filterable placeholder="请选择" clearable @change="getCommunityList($event)">
          <el-option
      ...
      <el-row>
        ...
        <el-form-item>
          <el-button v-has="'sys:person:info'" type="primary" icon="el-icon-edit" :disabled="ids.length <= 0" @click="addOrUpdateHandle()">编辑</el-button>
        </el-form-item>
        <el-form-item>
          <el-button v-has="'sys:person:del'" type="primary" icon="el-icon-camera" :disabled="ids.length <= 0" @click="cameraHandle()">人脸采集</el-button>
        </el-form-item>
        <el-form-item>
          <el-button v-has="'sys:person:info'" type="primary" icon="el-icon-edit" :disabled="ids.length <= 0" @click="addOrUpdateHandle()">编辑</el-button>
        </el-form-item>
    ...
    <el-table ref="topictable" v-loading="loading" :height="tableHeight" :row-style="rowStyle" size="mini" border :data="tableData" @selection-change="selectionChangeHandle">
      ...
      <el-table-column prop="agentName" label="单位名称" show-overflow-tooltip align="center" width="150" />
      ...
      <el-table-column prop="createrTime" label="添加时间" show-overflow-tooltip align="center" width="150" />
    </el-table>
